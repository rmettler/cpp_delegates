...
TEST_SUITE_BEGIN(
    ...
    * doctest::description("Create empty delegates with:\n"
                           " - 'rome::fwd_delegate<...>::fwd_delegate()'\n"
                           " - 'rome::fwd_delegate<...>::fwd_delegate(std::nullptr_t)'\n"
                           "and test:\n"
...
static_assert(std::is_same<rome::fwd_delegate<void(int)>,
                  rome::fwd_delegate<void(int), rome::target_is_expected>>::value,
    "");

TEST_CASE("rome::fwd_delegate - test default constructed delegates") {
...
TEST_CASE("rome::fwd_delegate - test nullptr initialized delegates") {
