...
static bool mockedBehavior2a(int i) {
    return i > 0;
}

static bool mockedBehavior2b(int i) {
    return i < 0;
}
...
using delegates_to_test = std::tuple<
    Test<rome::delegate<void(int), rome::target_is_mandatory>, &mockedBehavior1,  &mockedBehavior1,  Mock>,
    Test<rome::delegate<void(int), rome::target_is_expected>,  &mockedBehavior1,  &mockedBehavior1,  Mock>,
    Test<rome::delegate<void(int), rome::target_is_optional>,  &mockedBehavior1,  &mockedBehavior1,  Mock>,
    Test<rome::delegate<bool(int), rome::target_is_mandatory>, &mockedBehavior2a, &mockedBehavior2b, Mock>,
    Test<rome::delegate<bool(int), rome::target_is_expected>,  &mockedBehavior2a, &mockedBehavior2b, Mock>
    >;
...
TEST_CASE_TEMPLATE_DEFINE("rome::delegate - swap targets", TTest, tests) {
    ...
    SUBCASE("swap two non-empty delegates") {
        ...
        SUBCASE("swap using delegate::swap") {
            dgt1.swap(dgt2);
            CHECK(Mock1::expectedCalls == Mock1::performedCalls);
    ...
    SUBCASE("swap non-empty with empty delegate") {
        Mock1 mockedTarget1{};
