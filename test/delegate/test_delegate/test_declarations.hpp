...
namespace declaration {
    ...
    constexpr void test_default_template_params() {
        using rome::delegate;
        static_assert(std::is_same<delegate<bool(int)>, delegate<bool(int), rome::tgt_dyn_req>>::value, "");
        static_assert(std::is_same<delegate<void(int)>, delegate<void(int), rome::tgt_dyn_req>>::value, "");
    }
